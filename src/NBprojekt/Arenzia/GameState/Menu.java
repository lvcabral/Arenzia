...
public class Menu extends GameState {
	...
	private String [] options = { "Spiel Starten", "Hilfe"}; 
	...
	public Menu( GameStateManager gameStateManager ) {  
		...
		try {
			...
			titleBanner = ImageIO.read(getClass().getResourceAsStream("/banner/titleBanner.png")); 
			  
			font = new Font("Harlow Solid", Font.TRUETYPE_FONT, 50); 
	...
	private void select() {
		switch ( currentOption ) {
			...
			case 0 : 
				...
				gameStateManager.setState(GameStateManager.TEST-1);
				break;
			// Hilfe
			case 1 : 
...
//		} 
	...
	public void draw(Graphics2D graphics) { 
		...
		// Ueberschrift  
		graphics.drawImage(titleBanner, GamePanel.WIDTH / 2 - 350, 130, 700, 151, null);
		...
		for (int i = 0 ; i < options.length ; i++) {
			...
			Game.drawCenteredString(options[i], GamePanel.WIDTH, 500 + i * 60, graphics);  
		} 
